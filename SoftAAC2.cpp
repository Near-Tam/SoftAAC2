...
SoftAAC2::~SoftAAC2() {
    ALOGE("zhiyuanLOG: I am in ~SoftAAC2.");
    aacDecoder_Close(mAACDecoder);
    delete[] mOutputDelayRingBuffer;
    ALOGE("zhiyuanLOG: I am out ~SoftAAC2.");
}

void SoftAAC2::initPorts() {
    ALOGE("zhiyuanLOG: I am in initPorts.");
    ...
    addPort(def);
    ALOGE("zhiyuanLOG: I am out initPorts");
}

status_t SoftAAC2::initDecoder() {
    ALOGV("initDecoder()");
    ALOGE("zhiyuanLOG: I am in initDecoder");
    ...
    ALOGE("zhiyuanLOG: I am out initDecoder");
    return status;
}

OMX_ERRORTYPE SoftAAC2::internalGetParameter(
        OMX_INDEXTYPE index, OMX_PTR params) {
    ALOGE("zhiyuanLOG: I am in internalGetParameter");
    switch ((OMX_U32) index) {
        case OMX_IndexParamAudioAac:
        {
            ...
            if (!isValidOMXParam(aacParams)) {
                ALOGE("zhiyuanLOG: I am out internalGetParameter case1 if1");
                return OMX_ErrorBadParameter;
            }

            if (aacParams->nPortIndex != 0) {
                ALOGE("zhiyuanLOG: I am out internalGetParameter case1 if2");
            ...
            ALOGE("zhiyuanLOG: I am out internalGetParameter case1");
        ...
        case OMX_IndexParamAudioPcm:
        {
            ...
            if (!isValidOMXParam(pcmParams)) {
                ALOGE("zhiyuanLOG: I am out internalGetParameter case2 if1");
                return OMX_ErrorBadParameter;
            }

            if (pcmParams->nPortIndex != 1) {
                ALOGE("zhiyuanLOG: I am out internalGetParameter case2 if2");
                return OMX_ErrorUndefined;
            }
            ...
            ALOGE("zhiyuanLOG: I am out internalGetParameter case2");
            return OMX_ErrorNone;
        }
        ...
        case OMX_IndexParamAudioProfileQuerySupported:
        {
            ...
            if (!isValidOMXParam(profileParams)) {
                ALOGE("zhiyuanLOG: I am out internalGetParameter case3 if1");
                return OMX_ErrorBadParameter;
            }

            if (profileParams->nPortIndex != 0) {
                ALOGE("zhiyuanLOG: I am out internalGetParameter case3 if2");
                return OMX_ErrorUndefined;
            }
            ...
            ALOGE("zhiyuanLOG: I am out internalGetParameter case3");
            return OMX_ErrorNone;
        }
        ALOGE("zhiyuanLOG: I am out internalGetParameter");
        default:
...
OMX_ERRORTYPE SoftAAC2::internalSetParameter(
    ...
    ALOGE("zhiyuanLOG: I am in internalSetParameter");
    switch ((int)index) {
        ...
        ALOGE("zhiyuanLOG: I am out internalSetParameter");
        default:
...
bool SoftAAC2::outputDelayRingBufferPutSamples(INT_PCM *samples, int32_t numSamples) {
    ALOGE("zhiyuanLOG: I am in outputDelayRingBufferPutSamples ");
    if (numSamples == 0) {
        return true;
    }
    ...
    ALOGE("zhiyuanLOG: I am out outputDelayRingBufferPutSamples");
    return true;
}

int32_t SoftAAC2::outputDelayRingBufferGetSamples(INT_PCM *samples, int32_t numSamples) {
    ALOGE("zhiyuanLOG: I am in outputDelayRingBufferGetSamples");
    ...
    mOutputDelayRingBufferFilled -= numSamples;
    ALOGE("zhiyuanLOG: I am out outputDelayRingBufferGetSamples");
    return numSamples;
}
...
/*mark! This function is so importent!*/
void SoftAAC2::onQueueFilled(OMX_U32 /* portIndex */) {
    ALOGE("zhiyuanLOG: I am in onQueueFilled");
    ...
    /*init inQueue and outQueue*/
    List<BufferInfo *> &inQueue = getPortQueue(0);
    List<BufferInfo *> &outQueue = getPortQueue(1);

    //ALOGE("zhiyuanLOG: I am sleeping ");
    
    //ALOGE(getPortQueue(0));
    while ((!inQueue.empty() || mEndOfInput) && !outQueue.empty()) {
        if (!inQueue.empty()) {
            INT_PCM tmpOutBuffer[2048 * MAX_CHANNEL_COUNT];    //  MAX_CHANNEL_COUNT = 8
    ...
    ALOGE("zhiyuanLOG: I am out onQueueFilled");
}

void SoftAAC2::onPortFlushCompleted(OMX_U32 portIndex) {
    ALOGE("zhiyuanLOG: I am in onPortFlushComleted");
    if (portIndex == 0) {
    ...
    ALOGE("zhiyuanLOG: I am out onPortFlushCompleted");
}

void SoftAAC2::drainDecoder() {
    // flush decoder until outputDelay is compensated
    ALOGE("zhiyuanLOG: I am in drainDecoder");
    while (mOutputDelayCompensated > 0) {
        // a buffer big enough for MAX_CHANNEL_COUNT channels of decoded HE-AAC
        INT_PCM tmpOutBuffer[2048 * MAX_CHANNEL_COUNT];
    ...
    ALOGE("zhiyuanLOG: I am out drainDecoder");
}

void SoftAAC2::onReset() {
    ALOGE("zhiyuanLOG: I am in onReset");
    drainDecoder();
    ...
    mSignalledError = false;
    mOutputPortSettingsChange = NONE;
    ALOGE("zhiyuanLOG: I am out onReset");
}

void SoftAAC2::onPortEnableCompleted(OMX_U32 portIndex, bool enabled) {
    ALOGE("zhiyuanLOG: I am in onPortEnableComleted");
    if (portIndex != 1) {
        return;
    }
    ...
    ALOGE("zhiyuanLOG: I am out onPortEnableCompleted");
}
...
android::SoftOMXComponent *createSoftOMXComponent(
    ...
    ALOGE("zhiyuanLOG: I am in createSoftOMXComponent.");
